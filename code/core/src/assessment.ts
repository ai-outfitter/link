...
export const capabilityDefinitions: readonly CapabilityDefinition[] = [
  { id: "repository-context", dimension: "context", requiredForRung: 1, requiredState: "detected", title: "Repository context" },
  { id: "accountable-ownership", dimension: "guardrails", requiredForRung: 1, requiredState: "detected", title: "Accountable ownership" },
  { id: "shared-agent-context", dimension: "context", requiredForRung: 2, requiredState: "detected", title: "Shared agent context" },
  { id: "named-workflow-responsibility", dimension: "workflow", requiredForRung: 2, requiredState: "detected", title: "Named workflow responsibility" },
  { id: "agent-identity", dimension: "identity-and-authority", requiredForRung: 2, requiredState: "detected", title: "Agent identity" },
  { id: "scoped-authority", dimension: "identity-and-authority", requiredForRung: 2, requiredState: "detected", title: "Scoped authority" },
  { id: "automated-agent-workflow", dimension: "workflow", requiredForRung: 3, requiredState: "exercised", title: "Automated agent workflow" },
  { id: "automated-review", dimension: "improvement", requiredForRung: 3, requiredState: "exercised", title: "Automated review" },
  { id: "controlled-change-landing", dimension: "auditability", requiredForRung: 3, requiredState: "enforced", title: "Controlled change landing" },
];
...
function capability(observation: RepositoryObservation, definition: CapabilityDefinition): CapabilityAssessment {
  ...
  return { capability: definition.id, dimension: definition.dimension, state, requiredForRung: definition.requiredForRung, requiredState: definition.requiredState, evidence, limitations };
}
